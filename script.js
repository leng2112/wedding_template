...
// Define both icons as strings (you can customize the paths)
const volumeOnSVG = `
...
audioToggle.addEventListener('click', () => {
  ...
  audioToggle.innerHTML = audio.muted ? volumeOffSVG : volumeOnSVG;
});
  ...
  document.addEventListener('visibilitychange', () => {
    if (document.visibilityState === 'hidden') {
      ...
      console.log("Document visible - optionally resume audio");
      // Uncomment to resume automatically:
      // audio.play().catch(err => console.warn("Resume failed:", err));
    }
  });
  ...
  // Initialize Bootstrap tooltip (if needed)
