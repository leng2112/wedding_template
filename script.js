...
// ===== SVG icons =====
const volumeOnSVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="#C7A754" class="p-1" width="32" height="32">
...
const volumeOffSVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="#C7A754" class="p-1" width="32" height="32">
...
startButton.addEventListener('click', () => {
  ...
  audioIcon.innerHTML = volumeOnSVG; // Update toggle button icon
});

// ===== Toggle mute/unmute with SVG button =====
audioToggle.addEventListener('click', () => {
  audio.muted = !audio.muted;
  audioIcon.innerHTML = audio.muted ? volumeOffSVG : volumeOnSVG;
  if (!audio.muted) resumeAudio();
});
